...
def main() -> int:
    ...
    facts = [
        VendorFacts(vendor="Pinecone", monthly_amounts=[1000.0, 2400.0], cadence="monthly",
                    sample_descriptors=["PINECONE SYSTEMS INC"], sample_memos=[]),
        VendorFacts(vendor="Datadog", monthly_amounts=[3100.0, 3350.0, 3600.0, 3900.0], cadence="monthly",
                    sample_descriptors=["DATADOG INC"], sample_memos=["observability"]),
        VendorFacts(vendor="Twilio", monthly_amounts=[820.0, 790.0, 1210.0, 860.0], cadence="monthly",
                    sample_descriptors=["TWILIO* USAGE"], sample_memos=[]),
        VendorFacts(vendor="NIMBLEWAY LTD", monthly_amounts=[450.0, 450.0, 450.0], cadence="monthly",
                    sample_descriptors=["NIMBLEWAY LTD LONDON GB"], sample_memos=[]),
    ]
